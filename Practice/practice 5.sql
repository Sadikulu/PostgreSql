...
select srk.sirket_id,srk.sirket_isim,sip.siparis_id,sip.siparis_tarihi
from sirketler as srk inner join siparisler as sip
...
from sirketler as srk left join siparisler as sip 
on srk.sirket_id=sip.sirket_id;
...
select srk.sirket_id,srk.sirket_isim,sip.siparis_id,sip.siparis_tarihi
from sirketler as srk full join siparisler as sip 
on srk.sirket_id=sip.sirket_id;
