...
(                                                                                             
id serial primary key,--serial bize id'yi auto increment gibi otomatik olarak arttırır                                                                      
isim varchar(20),                                                                             
yas int,                                                                                      
maas int,                                                                                     
email varchar(30)                                                                             
...
select * from personel where  email !~~* '%gmail.com';--% ile yapılan aramalarda null gelmez
...
select * from personel where yas IN (39,48,54);
