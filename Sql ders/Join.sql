...
--1) INNER JOIN
--Ortak companyler için company_name, order_id ve 
--order_date değerlerini çağırın.
select mc.company_name,o.order_id,o.order_date 
from my_companies mc inner join orders o
on mc.company_id=o.company_id;

-- 2) LEFT JOIN
--my_companies table'ındaki companyler için order_id ve
--order_date değerlerini çağırın.
select mc.company_name,o.order_id,o.order_date 
...
--FULL JOIN
--İki table'dan da company_name, order_id ve 
--order_date değerlerini çağırın.
select mc.company_name,o.order_id,o.order_date 
