...
--on delete cascade kullandığımız için parent tableden direkt sildik
--parent tableden sildiğimiz için child tableden de silinmiş olur
delete from talebeler;
drop table talebeler cascade;
--parent tabloyu kaldırmak istersek drop table tablo adı'ndan sonra
--cascade komutu kullanırız

--talebeler tablosundaki isim sutununa not null kısıtlaması ekleyiniz
...
--talebeler tablosundaki yazılı notu sutununa 60'dan büyük rakam girilebilsin
alter table talebeler
...
--sınır olduğu için hata veriyor
...
--child tabloyu parent tablodan oluşturduğumuz için sutun adı vermedik
...
/*
  and() belirtilen şartların her ikiside gerçekleşiyorsa o kayıt listelenir
...
hem sınav1 veya sınav2 alanı 50'den büyük kayıtları listeler*/
...
--maası 70000 ve ismi sena beyaz olan personeli listele
select * from personel where isim='Sena Beyaz' and maas='70000';
--and olduğu için her iki şartı gerçekleştirmediğinden liste boş geldi

--IN birden fazla mantıksal ifade ile tanımlayabileceğimiz durumları tek
--komutta yazabilme imkanı verir
