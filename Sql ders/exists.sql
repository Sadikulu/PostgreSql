--EXİSTS, NOT EXİSTS--
/*Exists condition subquary ile kullanılır IN ifadesinin kullanımına benzer
Exists ve Not Exists ifadeleri alt sorgudan getirilen değerlerin içerisinde
...
exists (select urun_isim from mart where mart.urun_isim=nisan.urun_isim);
